/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example` (hash: 65a2b37923500fdfd261b574444ec150)
// Runtime types generated with workerd@1.20260903.1 2026-09-04 nodejs_als
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SPRITE_NAME: "josh-desktop";
	GATEWAY_WS_URL: "ws://localhost:8788/vnc";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SPRITE_NAME" | "GATEWAY_WS_URL" | "SPRITES_TOKEN" | "TICKET_SECRET">> {}
}
